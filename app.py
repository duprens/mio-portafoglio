...
if st.session_state.cliente_selezionato == "":
    ...
    if not df.empty:
        ...
        # Isoliamo ESATTAMENTE le 10 colonne della tua Bibbia
        ...
        # Formattazione grafica identica
        try:
        ...
        # Il data_editor sostituisce st.dataframe mantenendo la stessa identica vista
